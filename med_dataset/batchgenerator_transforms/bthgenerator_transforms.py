...
from med_dataset.batchgenerator_transforms.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, MoveSegAsOneHotToData, ApplyRandomBinaryOperatorTransform, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform
from med_dataset.batchgenerator_transforms.downsampling import DownsampleSegForDSTransform3, DownsampleSegForDSTransform2
...
def get_moreDA_transform(patch_size, params=default_3D_augmentation_params, border_val_seg=-1,
                        order_seg=1, order_data=3, deep_supervision_scales=None,
                        soft_ds=False, classes=None):
    ...
    tr_transforms.append(SpatialTransform(
        patch_size, patch_center_dist_from_border=params.get("patch_center_dist_from_border"),
